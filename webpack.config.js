...
module.exports = {
    ...
    entry: "TJ-province/public/js/static/provinceGoodsList.js", 
    //countyRealtimeOne  chinaRealDataList cityRealDataList ProvinSingleTime ProvinSingleDouble doubleCanvasLine provinceGoodsList chinaMonitor 
    // provinceGoodsList2 countyRealtime
    output: {
        publicPath: "TJ-province/public/build/",
        path: path.join(__dirname, "TJ-province/build"),
        filename: "provinceGoodsList.min.js"
    },
    module: {
        preLoaders: [
